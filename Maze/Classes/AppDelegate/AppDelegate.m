...
//	[window addSubview: viewController.view];
    ...
    [[GameManager sharedGameManager] splashScene];
}
...
- (void) applicationDidEnterBackground:(UIApplication*)application {
    ...
    if ([GameManager sharedGameManager].webViewDisplayed) {
        ...
        [[GameManager sharedGameManager].webView removeFromSuperview];
        [[GameManager sharedGameManager].webView release];
        [[GameManager sharedGameManager].closeButton removeFromSuperview];
